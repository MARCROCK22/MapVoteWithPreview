...
namespace MapVoteWithPreview {
    ...
    internal sealed class MapVote : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            PreviewEnabled = Config.Bind("Preview", "Preview Enabled", true, new ConfigDescription("When true - enables the map preview freecam feature"));
            FreecamSpeed = Config.Bind("Preview", "Freecam Speed", 10f, new ConfigDescription("Speed of the freecam when previewing a map", new AcceptableValueRange<float>(1f, 50f)));

            // Create the preview manager object
        ...
        internal static void Initialize()
        {
            ...
            OnPreviewStart = new NetworkedEvent("OnPreviewStart", HandleOnPreviewStart);
            OnPreviewEnd = new NetworkedEvent("OnPreviewEnd", HandleOnPreviewEnd);
